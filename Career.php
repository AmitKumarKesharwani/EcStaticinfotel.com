...
<html lang="en">
  <head>
     <title>Ecstatic Infotel Pvt Ltd || Career</title>
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-8">
            <div class="header-inner-title text-center">
              <h1 class="text-white font-weight-normal">Career</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-9">
            <div class="section-title text-center">
              <h2>Current career opportunities at Ecstatic Infotel Pvt. Ltd</h2>
        ...
        <div class="row mt-4 mt-md-5">
          <div class="col text-center">
            ...
            <a href="Contact.php" class="btn btn-primary btn-round text-white w-space">Contact Us <i class="fas fa-arrow-right ps-3"></i></a>
