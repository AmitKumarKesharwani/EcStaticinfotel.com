...
<div class="container mt-4 mb-4" style="border-style:inset;border-color:blue" data-aos="fade-up" data-aos-offset="-200">
         ...
         <div class="justify-content-center">
          ...
          <div class="site-block-half d-block d-lg-flex mt-5" data-aos="fade" data-aos-delay="100" >
             <a href="#" class="image d-block ab-image" style="background-image: url('admin/imagess/<?= $show['images'];?>');"></a>
            <div class="text">
            <span class="d-block mb-4"><span class="display-4 text-primary"  style="font-size: 28px"><?= $show['Heading'];?></span> <p><?= $show['dt'];?></p>
