...
<?php include 'CssLinks.php'; ?>
 ...
 <!--=================================
    footer--> 
    <!-- <div class="bg-dark"><h2 class="text-white">gduytu</h2></div> -->
    ...
    <div class="footer footer-top mb-3">
        <div class="container"  style="color:;background-image:url('images/mnb.jpeg');     background-repeat: no-repeat;  background-size: 100% 100%;">
          
          <h2 class="text-center pt-4 mt-4 " style="color: white">Which Module Fit Your Company </h2>
          <br>
          <p class="text-center" style="color: white">We will be happy to advise you on the ideal combination for your company.</p>

          <h3 class="text-center mt-4" style="color: white">Exactly what you need</h3>
          <p class="text-center" style="color: white">no more no less!</p>
...
Patna - 800010
              ...
              <p>
                <i class="fas fa-phone-volume mr-3 fa-fw text-white mb-2 mb-sm-0"></i> <a href="tel:919128015035" class="text-white font-15">+(91) 9128015035</a>
              </p>
               <p>
                <i class="far fa-envelope-open mr-3 fa-fw text-white mb-2 mb-sm-0"></i> <a href="info@ecstaticinfotel.com" class="font-15 text-white" target="_blank">info@ecstaticinfotel.com</a>
              </p>
            </div>
...
<div class="row">
    ...
    <!--=================================
    Back To Top-->
	<a href="https://api.whatsapp.com/send?phone=9128015035&text=Hello" class="float" target="_blank">
